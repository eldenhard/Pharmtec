...
<br>
        <div style="max-height: 45vh; overflow: auto;">
            ...
            <table class="table table-bordered table-hover table-sm">
                ...
                <tbody>
                    <tr v-for="(item, index) in data_fin_report" :key="item.id" :class="{notConfirm: !item.is_confirmed, notConfirmBuh: !item.is_accounting_confirmed && item.is_confirmed}">
                        <td>{{ index + 1 }}</td>
        ...
        <p>Транзакции за выбранный месяц</p>
    </div>
</template>
...
export default {
    ...
    setup() {
        // watch(data_fin_report, () => {
        //         data_fin_report.value.sort((a, b) => a.on_date.localeCompare(b.on_date))
        //     })
        return {
