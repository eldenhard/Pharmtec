                    ...
                    <div class="s_line">
                        ...
                        <div class="information_block">
                            <div class="information_block_top_block">
                                ...
                                <div>
                                    <p>День рождения: <span>{{  _user_data?.birth_date?.split("-").reverse().join('.') }}</span></p>
...
import { ref, onBeforeMount, onMounted, onBeforeUpdate, computed } from 'vue'
